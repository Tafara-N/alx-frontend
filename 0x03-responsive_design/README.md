...
![Wireframe of the Techium project - mobile version](images/wireframe.png)
...
![Wide screen](images/wide.png)

**Narrow screen:**

![Narrow screen](images/narrow.png)
...
![Rendering on wide screen](images/wide_screen.png)

**Rendering on screen with max-width: 767px**

![Rendering on a narrow screen](images/narrow_screen.png)

**Rendering on screen with max-width: 767px, you can see the navbar is hidden**

![Rendering on a narrow screen: hidden](images/navbar_hidden.png)
